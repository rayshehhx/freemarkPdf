package com.demo.yao.pdfdemo.utils;
 ...
 * @Author: yaoerfei
 * @Description:
 * @Date: Created in 下午1:51 2020/3/8
 * @Version:
 * @Modified By :
 */
...
//            renderer.getFontResolver().addFont("/templates/font/SIMSUN.TTC", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
            ...
            String url = PDFTemplateUtil.class.getClassLoader().getResource("templates/images").toURI().toString();
